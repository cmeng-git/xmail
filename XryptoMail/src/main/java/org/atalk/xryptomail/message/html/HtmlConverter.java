...
public class HtmlConverter
{
    ...
    private static class HtmlToTextTagHandler implements Html.TagHandler
    {
        ...
        private static final String IGNORED_ANNOTATION_KEY = "XryptoMail_ANNOTATION";
        ...
        /**
         * Fetch the matching opening Annotation object and verify that it's the one added by XryptoMail.
         *
    ...
    {
        final String font = XryptoMail.messageViewFixedWidthFont()
                ? "monospace"
                : "sans-serif";
