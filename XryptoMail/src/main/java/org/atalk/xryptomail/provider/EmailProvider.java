...
import org.atalk.xryptomail.cache.EmailProviderCacheCursor;
 ...
 * apps to access XryptoMail content using this content provider.
 * </p>
 */
/*
 * TODO:
...
public class EmailProvider extends ContentProvider
{
    ...
    private void createThreadedSubQuery(String[] projection, String selection, StringBuilder query)
    {
        ...
        query.append(" FROM " + MESSAGES_TABLE + " m " +
