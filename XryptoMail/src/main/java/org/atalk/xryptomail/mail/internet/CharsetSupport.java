...
public class CharsetSupport
{
            ...
            throws IOException
    {
        ...
        if (JisSupport.isShiftJis(charset) && !Charset.isSupported(charset)) {
            // If the JIS variant is iPhone, map the Unicode private use area in iPhone to the one
            // in Android after converting the character set from the standard Shift JIS to Unicode.
