...
public abstract class Message implements Part, Body
{
    ...
    /**
     * @param flag Flag to set. Never <code>null</code>.
     * @param set If <code>true</code>, the flag is added. If <code>false</code>
     * , the flag is removed.
     * @throws MessagingException
     */
     ...
     * @param set
     */
    public void setFlags(final Set<Flag> flags, boolean set)
            throws MessagingException
    {
        for (Flag flag : flags) {
            setFlag(flag, set);
     ...
     * {@link MessageView.Listener#loadMessageForViewHeadersAvailable(Account, String, String, Message)}
