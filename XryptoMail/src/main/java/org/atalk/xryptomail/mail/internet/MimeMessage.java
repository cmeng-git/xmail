...
public class MimeMessage extends Message
{
    ...
    /**
     * Setup Header for the given recipient type with the  addresses provided. If empty addresses
     * array is found, the method remove the Header Type.
