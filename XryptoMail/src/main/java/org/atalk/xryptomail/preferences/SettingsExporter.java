...
public class SettingsExporter {
    public static final String EXPORT_FILENAME_PREFIX = "XryptoMail_settings_export";
    public static final String EXPORT_FILENAME_SUFFIX = "XryptoMail";
    ...
    public static final String ROOT_ELEMENT = "XryptoMailsettings";
