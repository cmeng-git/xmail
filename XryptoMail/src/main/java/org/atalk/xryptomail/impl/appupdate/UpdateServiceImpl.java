...
/**
 * xmail update service implementation. It checks for an update and schedules .apk download using <code>DownloadManager</code>.
...
public class UpdateServiceImpl {
    ...
    private static final String[] updateLinks = {
            "https://raw.githubusercontent.com/cmeng-git/xmail/master/XryptoMail/release/version.properties",
            "https://atalk.sytes.net/releases/xryptomail-android/version.properties"
    };

    // filename is case-sensitive
    private static final String fileNameApk = String.format("/XryptoMail-%s.apk", BuildConfig.BUILD_TYPE);
    // github apk is in the release directory; for apk size download
    private static final String urlApk = "https://github.com/cmeng-git/xmail/releases/download/%s";
    ...
    public void checkForUpdates() {
        ...
        if ((downloadLink != null)) {
            ...
            XryptoMail.showToastMessage(R.string.app_update_none);
        }
    }
    ...
    private void downloadApk() {
        ...
        if (downloadReceiver == null) {
            ...
            ContextCompat.registerReceiver(XryptoMail.getGlobalContext(), downloadReceiver,
    ...
    private boolean isValidApkVersion(Uri fileUri, long versionCode) {
        ...
        if (apkFile.exists()) {
            ...
            if (pckgInfo != null) {
                ...
                if (!isValid) {
                    XryptoMail.showToastMessage(R.string.app_version_invalid, apkVersionCode, versionCode);
