...
public class MessagingControllerCommands {
    ...
    public static class PendingMoveOrCopy extends PendingCommand {
        ...
        public static PendingMoveOrCopy create(String srcFolder, String destFolder, boolean isCopy, Map<String, String> uidMap) {
        ...
        private PendingMoveOrCopy(String srcFolder, String destFolder, boolean isCopy, List<String> uids, Map<String, String> newUidMap) {
    ...
    public static class PendingEmptyTrash extends PendingCommand {
        ...
        @Override
        public void execute(MessagingController controller, Account account)
